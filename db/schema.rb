...
ActiveRecord::Schema.define(version: 20160301123359) do
  ...
  create_table "admin_category_products", force: :cascade do |t|
  ...
  create_table "admin_groups_menus", id: false, force: :cascade do |t|
    t.integer  "group_id"
    t.integer  "menu_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "admin_product_profile_pictures", force: :cascade do |t|
    t.string   "image"
    t.integer  "product_id"
    t.integer  "seq"
    t.datetime "created_at", null: false
  ...
  create_table "admin_sub_products", force: :cascade do |t|
    t.string   "size"
    t.string   "color"
    t.integer  "qty"
    t.string   "itemcode"
